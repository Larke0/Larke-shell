...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 4, spring = "spring_window", style = "popin 95%" })
...
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 5, spring = "spring_special", style = "slidefadevert 30%" })
